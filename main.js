...
function cancelarReserva() {
    var tiempoRestante = document.querySelector('.top-corn h1');
    ...
    if (confirm("¿Estás seguro de que quieres cancelar la reserva?")) {
        ...
        // Preguntar si el usuario desea cambiar la reserva
...
function alargarReserva() {
    var tiempoRestante = document.querySelector('.top-corn h1');
    var tiempoAdicional = prompt("¿Cuántas horas quieres añadir a la reserva?");
...
window.onload = function() {
    ...
    var btnAlargar = document.querySelector('.cent .can:nth-child(1) a.hola');
    btnAlargar.onclick = function(event) {
        event.preventDefault(); // Prevenir el comportamiento por defecto del enlace
        alargarReserva();
    };

    // Botón "Cancelar reserva"
    var btnCancelar = document.querySelector('.cent .can:nth-child(2) a.hola');
